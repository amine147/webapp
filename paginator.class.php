...
class Paginator{
	...
	public function display_items_per_page() {
		...
		return "<span class=\"paginate\">Transactions par page: </span><select class=\"paginate\" onchange=\"window.location='$_SERVER[PHP_SELF]?page=1&amp;ipp='+this[this.selectedIndex].value+'$this->querystring';return false\">$items</select>\n";
	}
